    ...
    <section class="product_description_area bg-white p_80">
        <div class="container">
            ...
            <div class="col-12">
                ...
                <form class="billing_inner row" method="post" action="{{ url('buyer/request/add') }}">
                    @csrf
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="font-weight-bold" for="desc">Jelaskan jasa yang ingin Anda cari - diharapkan sedetail mungkin: <span>*</span></label>
                            <textarea name="description" class="form-control" id="desc" rows="3" placeholder="Jelaskan jasa yang ingin Anda cari - diharapkan sedetail mungkin" required minlength="10"></textarea>
                        </div>
                    <hr>
                    </div>
                    <div class="col-lg-12">
                    ...
                    <div class="col-lg-12">
                    <div class="form-group">
                        <label for="jasa_time">Setelah Anda melakukan pemesanan, kapan Anda ingin jasa Anda dikirim?<span>*</span></label>
