            ...
            <div class="carousel_top_h_inner">
                    ...
                    {{-- <div class="top_header_left">
                        <div class="selector">
                            <select class="language_drop" name="countries" id="countries" style="width:300px;">
                              <option value='yt' data-image="{{asset('img/icon/flag-1.png')}}" data-imagecss="flag yt" data-title="English">English</option>
                              <option value='yu' data-image="{{asset('img/icon/flag-1.png')}}" data-imagecss="flag yu" data-title="Bangladesh">Bangla</option>
                              <option value='yt' data-image="{{asset('img/icon/flag-1.png')}}" data-imagecss="flag yt" data-title="English">English</option>
                              <option value='yu' data-image="{{asset('img/icon/flag-1.png')}}" data-imagecss="flag yu" data-title="Bangladesh">Bangla</option>
                            </select>
                        </div>
                ...
                <div class="float-md-right">
                    <div class="top_header_middle">
                        ...
                        <a href="#"><i class="fa fa-envelope"></i> Email: <span>kelompokuniversal@gmail.com</span></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown submenu active">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            About My Jasa <i class="fa fa-angle-down" aria-hidden="true"></i>
                            </a>
                            <ul class="dropdown-menu">
                                <li class="nav-item"><a class="nav-link" href="{{ url('/seller/jasa/create/0') }}">Create Jasa</a></li>
                                <li class="nav-item"><a class="nav-link" href="{{ url('/seller/jasa') }}">My Jasa</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown submenu">
                            <a class="nav-link dropdown-toggle" href="{{ url('/jasa/1') }}">Jasa</i></a>
                        </li>
                        ...
                        @endif
                        @else
                        <li class="nav-item"><a class="nav-link" href="{{ url('request') }}">Find request</a></li>
                        <li class="nav-item dropdown submenu">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
