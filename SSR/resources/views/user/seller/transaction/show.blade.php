        ...
        <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    <p class="mb-4 text-muted">{{ date('d F Y', strtotime($transaksi->started_at)) }}</p>
                                    @else
                                ...
                                <div class="col-4">
                                    ...
                                    @if ($transaksi->started_at !=  '')
                                    <p class="mb-4 text-muted">{{ date('d F Y', (60 * 60 * 24 * $transaksi->transaksi_delivery_time) + strtotime($transaksi->started_at)) }}</p>
                                    @else
                                    <p class="mb-4 text-muted">-</p>
                                    @endif
                                </div>
          ...
          <div class="col-lg-5">
            <div class="order_box_price">
              <h2 class="reg_title">Pesanan {{ $transaksi->buyer->name }}</h2>
