    ...
    <div class="latest_product_3steps">
      <div class="s_m_title">
        <div class="c_main_title">
          <h2 style="font-size: 3rem;">Incoming Transaction</h2>
        </div>
        <div class="row justify-content-center">
          You can manage your transaction in seller point of view.
        </div>
      </div>
    </div>
                    ...
                    <div class="c_product_item">
                        ...
                        <div class="col-10">
                            <div class="c_product_text">
                                ...
                                <h6>{{ $transaksi->buyer->name }} is your client!</h6>
                                <a href="{{ url('seller/jasa/show') . '/' . $transaksi->jasa->jasa_id }}"><b>Related jasa</b></a>
                                ...
                                <ul class="c_product_btn mt-2">
                                    <li><a class="add_cart_btn" href="{{ url('seller/transaction/') . '/' . $transaksi->transaksi_id }}">Atur</a></li>
                                </ul>
                            </div>
                        </div>
                        </div>
                        ...
                        <div class="c_product_item">
                            <div class="row justify-content-center">
                                <div class="col-10">
                                    <div class="c_product_text">
                                        <h2>Transaction ID : {{ $transaksi->transaksi_id }}</h2>
                                        <h6>{{ $transaksi->buyer->name }} wants to hire you!</h6>
                                        <a href="{{ url('seller/jasa/show') . '/' . $transaksi->jasa->jasa_id }}"><b>Related jasa</b></a>
                                        ...
                                        <h3>Price : <span class="font-weight-bold">{{ number_format($transaksi->transaksi_price) }}</span></h3>
                                        <ul class="c_product_btn mt-2">
                                            <li><a class="add_cart_btn" href="{{ url('seller/transaction/accept/') . '/' . $transaksi->transaksi_id }}">Accept</a></li>
                                            <li><a class="add_cart_btn" href="{{ url('seller/transaction/decline/') . '/' . $transaksi->transaksi_id }}">Decline</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
...
@section('customjs')
<script>
  function removeOffer(transaksi_id) {
    Swal.fire({
      ...
      if (result.value) {
        ...
        window.location.href = "{{ url('seller/transaction/decline/') }}" + "/" + transaksi_id;
      }
    });
  }
</script>
